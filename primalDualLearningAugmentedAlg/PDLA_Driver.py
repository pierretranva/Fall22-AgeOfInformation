...
def main():
    ...
    replacementRates = [0, 0.05, 0.1, 0.15, 0.20, 0.25, 0.30, 0.35, 0.40, 0.45, 0.50, 0.55, 0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 1.0]
    ...
    for prob in replacementRates:
        for i in range(numExperiments):
            distInstance = Dist.distrib_instance_gen(meanDist, lenTimeIntervals, numIterations, shape, key)
            # (solution, OPTCost)
